...
run_delete_test "Borrado exitoso" "http://localhost:8080/api/users/$USER_ID/ratings/$MOVIE_ID" 204

# Caso 2: Rating no encontrado
run_delete_test "Rating no encontrado" "http://localhost:8080/api/users/$USER_ID/ratings/$MOVIE_ID_NO_RATING" 404

# Caso 3: Usuario no encontrado
run_delete_test "Usuario no encontrado" "http://localhost:8080/api/users/999999/ratings/$MOVIE_ID" 404
