...
run_get_test "Obtención exitosa" "$APP_TEST_URL/api/users/$USER_ID/ratings/$MOVIE_ID" 200

# Caso 2: Usuario no encontrado
run_get_test "Usuario no encontrado" "$APP_TEST_URL/api/users/999999/ratings/$MOVIE_ID" 404

# Caso 3: Película no encontrada
run_get_test "Película no encontrada" "$APP_TEST_URL/api/users/$USER_ID/ratings/999999" 404

# Caso 4: ID de usuario inválido
run_get_test "ID de usuario inválido" "$APP_TEST_URL/api/users/abc/ratings/$MOVIE_ID" 500
