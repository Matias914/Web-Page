...
echo -e "
===== INICIANDO PRUEBAS PARA GET /api/movies/{id}/ratings ====="

# Setup: Crear película para las pruebas
MOVIE_ID=$(create_movie "" '{"title": "Get Movie Ratings", "synopsis": "s", "released_at": "2023-01-01T00:00:00Z", "duration_minutes": 100}')
...
if [[ "$FAILED" -eq 0 ]]; then
    echo -e "Todas las pruebas para GET /api/movies/{id}/ratings pasaron exitosamente. ✅
"
fi
